...
<form action="" method="POST">
 <div class="main">
    <div class="content">
    	...
    	<img src="images/QR_1.jpg" alt style="padding-left: 150px; max-width: 40%;">
    	<img src="images/QR_2.jpg" alt style="max-width: 40%;">
    	<div>
    		<h2 style="padding: 40px">Khi thanh toán, khách hàng ghi rõ: HỌ TÊN VÀ SỐ ĐIỆN THOẠI. 
    		Sau khi thao tác chuyển khoản xong xin hãy nhấn nút ĐẶT HÀNG. Shop nhận đủ số tiền, đơn hàng như mẫu sẽ xác nhận đơn và bắt đầu chuyển hàng cho quý khách. Xin cảm ơn! </h2>
    	</div>
