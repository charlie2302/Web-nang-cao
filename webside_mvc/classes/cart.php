     ...
     class cart
     {
        ...
        public function update_quantity_cart($quantity, $cartId){
            ...
            if($result){
                ...
                $msg = "<span class='error'>Số lượng sản phẩm chưa được sửa</span>";
                return $msg;
            }
        }
        ...
        public function del_product_cart($cartid){
            ...
            if($result){
                ...
                $msg = "<span class='error'>Không thể xoá sản phẩm</span>";
                return $msg;
            }
        }
        ...
        public function shifted($id,$time,$price){
            ...
            $result = $this->db->update($query);
            if($result){
                $msg = "<span class='success'>Cập nhật tình trạng thành công</span>";
                return $msg;
            }else{
                $msg = "<span class='error'>Cập nhật tình trạng chưa thành công</span>";
                return $msg;
            }
        }
        ...
        public function del_shifted($id,$time,$price){
            ...
            $result = $this->db->update($query);
            if($result){
                $msg = "<span class='success'>Xoá đơn hàng thành công</span>";
                return $msg;
            }else{
                $msg = "<span class='error'>Xoá đơn hàng chưa thành công</span>";
                return $msg;
            }
        }
